...
--awful.util.tagnames = {  "", " ", " ", " ", " ", " ", " ", " ", " ", " "  }
awful.util.tagnames = { " DEV ", " WWW ", " SYS ", " DOC ", " FILE ", " CHAT ", " MUS ", " VID ", " GFX " }
...
globalkeys = my_table.join(
  ...
  --  awful.key({ altkey, "Control"  }, "s", function () awful.util.spawn( "./.dmenu/dmenu-surfraw.sh" ) end,
    ...
    -- My applications (Super+Alt+Key)
     ...
     awful.key({ modkey, altkey },            "b",     function () awful.util.spawn("firefox")end,
      ...
      awful.key({ modkey, altkey },            "d",     function () awful.util.spawn("dolphin")end,
              {description = "run dolphin", group = "Applications"}),
      
    --Code
     awful.key({ modkey, altkey },            "e",     function () awful.util.spawn("emacs")end,
              {description = "run emacs", group = "Applications"}),
      
       --nautilus
     awful.key({ modkey, altkey },            "n",     function () awful.util.spawn("pcmanfm")end,
              {description = "run pcmanfm", group = "Applications"}),
     
	--vifm
	awful.key({ modkey, altkey },            "f",     function () awful.util.spawn("alacritty -e vifm ")end,
              {description = "run VIFM", group = "Applications"}),
	
      --writer
      awful.key({ modkey,altkey },            "w",     function () awful.util.spawn("libreoffice --writer")end,
      {description = "run Writer", group = "Applications"}),

      --timeshift
      awful.key({ modkey,altkey },            "u",     function () awful.util.spawn("timeshift-launcher")end,
      {description = "run timeshift", group = "Applications"}),

      --pavucontrol
      awful.key({ modkey,altkey },            "p",     function () awful.util.spawn("pavucontrol")end,
      {description = "run pavucontrol", group = "Applications"}),

      --teams
      awful.key({ modkey,altkey },            "t",     function () awful.util.spawn("teams")end,
      {description = "run teams", group = "Applications"}),

      --qbittorrent
      awful.key({ modkey,altkey },            "q",     function () awful.util.spawn("qbittorrent")end,
      {description = "run qbittorrent", group = "Applications"}),

    -- screenshots using flameshot

      awful.key({ modkey,altkey },            "s",     function () awful.util.spawn("flameshot gui")end,
      {description = "run flameshot", group = "Screenshot"}),
   ...
   -- awful.key({ modkey }, "Right", function () lain.util.tag_view_nonempty(1) end,
    ...
    -- Standard program
    awful.key({ modkey}, "x", function () awful.spawn( "alacritty -e fish" ) end,
              {description = "terminal with fish", group = "super"}),
    ...
    awful.key({ modkey, "Shift"   }, "q",  function () awful.spawn.with_shell( '~/.dmenu/prompt "are you sure?" "killall awesome"' ) end,
      ...
      --arcolinux-logout
      awful.key({ modkey,"Shift" },            "s",     function () awful.util.spawn("arcolinux-logout")end,
      {description = "run arcolinux-logout", group = "awesome"}),
