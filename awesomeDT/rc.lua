...
--local editor            = os.getenv("nano") or "vim"
...
globalkeys = my_table.join(
  ...
  --  awful.key({ altkey, "Control"  }, "s", function () awful.util.spawn( "./.dmenu/dmenu-surfraw.sh" ) end,
   ...
   -- awful.key({ altkey, "Control"  }, "t", function () awful.util.spawn( "./.dmenu/dmenu-trading.sh" ) end,
    ...
    --Code
     awful.key({ modkey, altkey },            "c",     function () awful.util.spawn("code")end,
              {description = "run visual studio", group = "Applications"}),
      
       --nautilus
     awful.key({ modkey, altkey },            "n",     function () awful.util.spawn("nautilus")end,
              {description = "run nautilus", group = "Applications"}),
     
	--vifm
	awful.key({ modkey, altkey },            "v",     function () awful.util.spawn("alacritty -e vifm ")end,
