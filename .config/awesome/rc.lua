...
globalkeys = my_table.join(
    ...
    awful.key({ modkey, altkey }, "b", function () awful.util.spawn( browser ) end,
        {description = "web browser" , group = "gui apps" }),
    ...
    awful.key({ modkey, altkey }, "m", function () awful.util.spawn( music) end,
        {description = "music player" , group = "gui apps" }),

    awful.key({ modkey, altkey }, "p", function () awful.util.spawn( sound ) end,
        {description = "sound manager" , group = "gui apps" }),

    awful.key({ modkey, altkey }, "u", function () awful.util.spawn( backup) end,
        {description = "backup manager" , group = "gui apps" }),

    awful.key({ modkey, altkey }, "t", function () awful.util.spawn( torrent ) end,
        {description = "torrent manager" , group = "gui apps" }),

    awful.key({ modkey, altkey }, "l", function () awful.util.spawn( office ) end,
        {description = "office" , group = "gui apps" }),

    awful.key({ modkey, altkey }, "n", function () awful.util.spawn( filemanager ) end,
        {description = "file manager" , group = "gui apps" }),
